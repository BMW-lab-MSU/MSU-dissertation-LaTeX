...
\msusection{Equations}\label{Sect:eqns}
...
\msusubsection{Symbols}\label{Sect:sym}
...
\msusection{Figures}\label{Sect:figs}
...
\msusection{Tables}\label{Sect:tabs}
...
\msusection{References and Citations}\label{Sect:ref_cite}

\msusubsection{Referencing other parts of the document}\label{Sect:ref}
...
\msusubsection{Citing others work}\label{Sect:cite}
