...
\msusection{Section}\label{Sect:test}
...
\msusubsection{Subsection}\label{Sect:testsub}
\lipsum[2] % Random text

\msusubsubsection{Subsubsection}\label{Sect:testsubsub}
\lipsum[3] % Random text

\msulongsubsection{Subsection with very long title}{Subsection with a very very very very very very very}{very very very very very very very very very long title}\label{Sect:longsub}
