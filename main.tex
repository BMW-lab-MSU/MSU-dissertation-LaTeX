...
%
% options 10pt, singlespaced and draft allow you to require less number of pages for editting
%
...
\usepackage{subfig}    % to be able to have multiple plots in one figure
\RequirePackage{color} % for changing text color in chapters \textcolor{red}{red text read here}. 
...
% =============================== %
\name{John Davis Doe} %PUT your FULL name here
...
% End matter
\begin{postliminary}
  \Appendtrue  %comment this out or remove if you do not have an appendix
